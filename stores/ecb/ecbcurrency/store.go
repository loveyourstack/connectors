...
func (s Store) SelectMapByNaturalKey(ctx context.Context) (itemsMap map[string]Model, stmt string, err error) {
...
func (s Store) SelectCodeIdMap(ctx context.Context) (codeIdMap map[string]int64, stmt string, err error) {
